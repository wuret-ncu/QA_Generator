            ...
            <div className="hero min-h-screen bg-base-200">
                <div className="hero-content flex-col lg:flex-row-reverse">
                            ...
                            {successMessage && (
                                <div className="alert alert-success shadow-lg">
                                    <div>
                                        ...
                                        <button className="btn btn-sm btn-primary" onClick={() => navigation("/")}>Accept</button>
                                    </div>
                                </div>)}
                    ...
                    <div className="text-center lg:text-left">
                        ...
                        <p className="py-6">Test your English skills through our <b className="text-secondary">reading test</b> and <b className="text-secondary">writing assessments</b>. With a variety of question types and difficulty levels, receive instant feedback and navigate with ease. Improve your English skills today by starting now!</p>
                    </div>
                </div>
            </div>
        </div>
